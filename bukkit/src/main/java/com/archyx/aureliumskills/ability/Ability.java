...
public enum Ability implements AbstractAbility {
	...
	TREASURE_HUNTER(() -> Skills.FISHING, 1.0, 1.0, new String[] {"scale_base_chance"}, new Object[] {false}),
	GRAPPLER(() -> Skills.FISHING, 50.0, 100.0),
	EPIC_CATCH(() -> Skills.FISHING, 0.4, 0.4, new String[] {"scale_base_chance"}, new Object[] {false}),
	METAL_DETECTOR(() -> Skills.EXCAVATION, 0.5, 0.4, new String[] {"scale_base_chance"}, new Object[] {false}),
	EXCAVATOR(() -> Skills.EXCAVATION, 10.0, 10.0),
	SPADE_MASTER(() -> Skills.EXCAVATION, 3.0, 2.0),
	BIGGER_SCOOP(() -> Skills.EXCAVATION, 3.0, 3.0),
	LUCKY_SPADES(() -> Skills.EXCAVATION, 0.1, 0.05, new String[] {"scale_base_chance"}, new Object[] {false}),
